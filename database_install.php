...
/*******************************************************************************
* Create new treas_config Table and insert some sample date, if not exist table
*******************************************************************************/

$trans_exists = $smcFunc['db_list_tables'](false, $db_prefix . 'treas_config');
