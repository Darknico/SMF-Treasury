...
<li>In the <a href="%2$ssa=configpaypal" style="text-decoration:underline;"><b>PayPal Config</b></a> tab, ensure you enter your own PayPal email ID (and your PayPal primary currency) - it simply will not work with the default email ID from install.<br><br></li>
...
<li>Check the other options in admin for setting up the <a href="%2$ssa=config" style="text-decoration:underline;"><b>Module</b></a> appearance (and <a href="%2$ssa=configblock" style="text-decoration:underline;"><b>Block</b></a> for Portal users).<br><br></li>
<li>You will need to setup your viewing and admin <a href="%1$s?action=admin;area=permissions" style="text-decoration:underline;"><b>permissions</b></a> for each member group.<br><br></li>
...
<li>Your monthly goals are displayed on the <a href="%1$s?action=treasury" style="text-decoration:underline;"><b>Treasury</b></a> page.<br><br></li>
</ol>';
...
'<ol>
<li>The <a href="%2$ssa=registry" style="text-decoration:underline;"><b>Registry</b></a> tab allows you to manage your site\'s <b>receipts &amp; expenses</b> with basic entries to record them.  You can also total your most recent user contributions as a single entry in the register by <a href="%2$ssa=registry" style="text-decoration:underline;"><b>Reconciling</b></a> your paypal receipts.  Should you wish to provide full disclosure to your donors, you can elect to display a summary of your Income &amp; Expenses to them.<br><br></li>
<li>The <a href="%2$ssa=configblock" style="text-decoration:underline;"><b>Block</b></a> is provided for Portal installations where you can have a side-block.  It allows you to display your current monthly donation goal and what funds have been received towards that goal. Display of Goals and/or Donormeter is now selectable. It also lists the users who have contributed in the current month.<br>The Treasury main page already provides all of this information.<br><br></li>
...
<li>Users can view their personal donation summary through their <a href="%1$s?action=profile;area=showdonations;u=1" style="text-decoration:underline;"><b>Profile</b></a> - viewable only by the user or admin.<br><br></li>
...
<li>Got an Internal Server <b>Error 500</b> when PayPal returns to your site?<br>Check file permissions for %3$s/ipntreas.php are 644 or 755 (CHMOD to 644 if they are 777 or 666).<br>Similarly if you are using %3$s/Sources/Treasury/DonationBlock.php under a Portal.<br><br></li>
<li>You can verify that your site will respond to PayPal by <a href="%3$s/ipntreas.php?dbg=1" style="text-decoration:underline;" target="_blank"><b>clicking here</b></a>.<br>
&#8226; This will also place an entry in your <a href="%2$ssa=translog" style="text-decoration:underline;"><b>transaction log</b></a>.<br><br></li>
<li>If you are having problems with transactions not appearing, check the <a href="%2$ssa=translog" style="text-decoration:underline;"><b>Transaction Log</b></a> for any clues to problems.<br>
&#8226; if they pay by echeck (3 days to clear) the log will contain "pending_reason => echeck".<br><br></li>
<li>Whenever IPN data is not stored in your database, you will have to manually enter the data from your PayPal Email in the bottom row <a href="%2$ssa=donations" style="text-decoration:underline;"><b>here</b></a>.<br><br></li>
<li>Treasury accepts pending payments, like eCheck, and stores the info in the database, with status of \'Pending\'.  When the eCheck clears, it should now receive the PayPal IPN info and automatically update your datbase - otherwise, you can change status to \'Completed\' in <a href="%2$ssa=donations" style="text-decoration:underline;"><b>Donations</b></a> and the donation will appear in your goals and donor list - you will need to add data for the fee, settle amount and exchange rate.<br><br></li>
...
&#8226; this means that the "business" field for a transaction is expected to match the "receiver email" address you specified in your <a href="%2$ssa=configpaypal" style="text-decoration:underline;"><b>PayPal Config</b></a> tab.<br>
